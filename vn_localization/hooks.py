...
app_include_css = "/assets/vn_localization/css/ai_chat_widget.css?v=20260428-translations"
app_include_js = "/assets/vn_localization/js/ai_chat_widget.js?v=20260428-translations"
